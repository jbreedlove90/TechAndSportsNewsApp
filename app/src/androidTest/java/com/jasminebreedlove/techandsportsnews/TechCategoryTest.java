...
public class TechCategoryTest {
    ...
    public void techCategoryTest() {
        ...
        // clicking on a random article
        ViewInteraction appCompatTextView = onView(
                allOf(withId(R.id.article_title), withText(" California moves to require solar panels on all new homes"),
                        childAtPosition(
                                childAtPosition(
        ...
        // clicking share fab button on tech article detail page
